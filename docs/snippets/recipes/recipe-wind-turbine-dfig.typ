...
#diagram(length: 1.2cm, {
  ...
  cetz.draw.line(
    apex,
    (rel: (0, -0.32), to: "conv.north-west"),
    stroke: 0.7pt + black,
  )
  cetz.draw.line(
    apex,
    (rel: (0, 0.32), to: "conv.south-west"),
    stroke: 0.7pt + black,
  )
  note(
    (rel: (0.6, -0.1), to: "b6.mid"),
    [-0,500 MW \ 0,000 Mvar],
    side: "south",
    text-align: center,
  )
  ...
  machine("G2", ("conv.center", "|-", "b5.mid"), "G", label: (
    content: align(center)[2,500 MW \ 0,467 Mvar],
    anchor: "north",
    distance: 0.2,
  ))
  wire("b5.mid", "G2.west")
