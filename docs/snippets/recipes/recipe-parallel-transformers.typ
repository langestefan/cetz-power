...
#diagram(length: 1.2cm, {
  ...
  transformer("t1", (hs1-x, upper-y), (ms1-x, upper-y), radius: 0.25, label: (
  ...
  transformer("t2", (hs1-x, lower-y), (ms1-x, lower-y), radius: 0.25, label: (
  ...
  cetz.draw.content(
    (rel: (0.10, 0), to: (hs1-x, upper-y)),
    anchor: "north-west",
    padding: 0.10,
    align(left)[39664 kW \ 33976 kvar \ 201 A],
  )
  cetz.draw.content(
    (rel: (0.10, 0), to: (hs1-x, lower-y)),
    anchor: "north-west",
    padding: 0.10,
  ...
  cetz.draw.content(
    (rel: (-0.10, 0), to: (ms1-x, upper-y)),
    anchor: "north-east",
    padding: 0.10,
    align(right)[-39652 kW \ -26935 kvar \ 2653 A],
  )
  cetz.draw.content(
    (rel: (-0.10, 0), to: (ms1-x, lower-y)),
    anchor: "north-east",
    padding: 0.10,
