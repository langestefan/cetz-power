...
#diagram(length: 1cm, {
  ...
  xb(1, P(46, 74), stroke: 0.8pt + red)
  xb(2, P(46, 160), stroke: 0.8pt + red)
  xb(3, P(145, 74))
  xb(4, P(145, 160)) // MV sides
  xb(5, P(185, 202)) // rail coupling
  xb(6, P(222, 131))
  xb(7, P(222, 245)) // ring feeder heads
  xb(8, P(406, 148))
  xb(9, P(449, 262)) // subring / spur taps

  // ── the two netopeningen: open blades at the top-right node ─────
  switch(
    "no1",
    P(684, 131),
    P(705, 131), // blade = full 21 px gap:
    switch-length: 21 * s,
    pivot-radius: 0,
    open-angle: -30deg,
  )
  switch(
    "no2",
    P(677, 157),
    P(677, 138), // no leftover stub slivers
    switch-length: 19 * s,
    pivot-radius: 0,
  )
  ...
  for (i, q) in open-pts.enumerate() {
    junction("o" + str(i), P(..q), open: true)
  }
