...
#diagram(length: 1cm, {
  ...
  cetz.draw.content((x-hs, topy + ext + 0.3), align(
    center,
  )[Onderstation HS \ 150,000 kV])
  wire("V.east", "hs.mid")
  ...
  cetz.draw.content((x-ms, topy + ext + 0.3), align(
    center,
  )[Onderstation MS \ 10,451 kV])
  ...
  cetz.draw.content((rel: (-0.2, -0.6), to: cp), align(
    center,
  )[Compensatie \ 19 A])
