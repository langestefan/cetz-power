...
#diagram(length: 1cm, {
  ...
  bus("b2", P(187, 38), P(187, 83))
  nl(P(187, 34), [2], "north")
  bus("b7", P(281, 38), P(281, 83))
  nl(P(281, 34), [7], "north")
  bus("b8", P(372, 38), P(372, 83))
  nl(P(372, 34), [8], "north")
  bus("b9", P(463, 38), P(463, 83))
  nl(P(472, 50), [9], "east")
  bus("b3", P(557, 38), P(557, 83))
  nl(P(557, 34), [3], "north")
  bus("b1", P(280, 169), P(280, 213))
  nl(P(280, 165), [1], "north")

  // ── middle network buses (horizontal) ───────────────────────────
  bus("b5", P(295.5, 104), P(343.5, 104))
  nl(P(289.5, 104), [5], "west")
  bus("b6", P(394, 104), P(442, 104))
  nl(P(450, 104), [6], "east")
  bus("b4", P(346, 159), P(393.5, 159))
  nl(P(401, 159), [4], "east")

  // ── DVPP buses (horizontal) ─────────────────────────────────────
  bus("d1b", P(364, 235), P(411, 235))
  nl(P(419, 235), [d1b], "east")
  bus("d1a", P(467.5, 235), P(588.5, 235))
  nl(P(596, 235), [d1a], "east")
  bus("d7", P(364, 289), P(411, 289))
  nl(P(419, 289), [d7], "east")
  bus("d5", P(452, 289), P(499, 289))
  nl(P(507, 289), [d5], "east")
  bus("d2", P(555, 289), P(606, 289))
  nl(P(614, 289), [d2], "east")
  bus("d8", P(352, 347), P(399, 347))
  nl(P(344, 347), [d8], "west")
  bus("d6", P(440, 347), P(487, 347))
  nl(P(432, 347), [d6], "west")
  bus("d3", P(525, 347), P(572, 347))
  nl(P(517, 347), [d3], "west")
  bus("d4", P(595, 347), P(642, 347))
  nl(P(650, 347), [d4], "east")
  ...
  nl(P(401, 200), [POC 2], "east")
  nl(P(541, 200), [POC 1], "east")
  ...
  sg("sg2", P(141, yc), [SG 2], "south")
  wire("sg2.east", P(187, yc))
  sg("sg3", P(593, yc), [SG 3], "south")
  wire("sg3.west", P(557, yc))
  sg("sg1", P(237, 191), [SG 1], "west")
  wire("sg1.east", P(280, 191))

  // ── transmission conductors ─────────────────────────────────────
  wire(P(281, yc), P(372, yc)) // 7-8
  wire(P(372, yc), P(463, yc)) // 8-9
  wire(P(281, 75), P(319.5, 75))
  wire(P(319.5, 75), P(319.5, 104)) // 7→5: horizontal off bus 7, down into bus 5 centre
  // 6→9 and the POC 1 feed share one collinear vertical off bus 6 (x432)
  wire(P(432, 104), P(432, 70))
  wire(P(432, 70), P(463, 70)) // 6→9
  wire(P(432, 104), P(432, 159))
  wire(P(432, 159), P(528, 159)) // bus6 → POC 1 feed
  // 4→5 / 4→6 funnels: perpendicular stub, diagonal, perpendicular stub (no angled bus joins)
  wire(P(335.5, 104), P(335.5, 116))
  wire(P(335.5, 116), P(352, 147))
  wire(P(352, 147), P(352, 159)) // 4-5 (mirror of 4-6 about bus4 centre)
  wire(P(404, 104), P(404, 116))
  wire(P(404, 116), P(387.5, 147))
  wire(P(387.5, 147), P(387.5, 159)) // 4-6
  ...
  wire(P(567, 289), P(567, 320))
  wire(P(567, 320), P(548.5, 320))
  wire(P(548.5, 320), P(548.5, 347)) // d2–d3 (symmetric on d2)
  wire(P(594, 289), P(594, 320))
  wire(P(594, 320), P(618.5, 320))
  wire(P(618.5, 320), P(618.5, 347)) // d2–d4 (symmetric on d2)
  wire(P(478, 347), P(478, 330))
  wire(P(478, 330), P(535, 330))
  wire(P(535, 330), P(535, 347)) // d6–d3 (staple; d3 leg aligned with load)
