...
#diagram(length: 1cm, {
  ...
  bus("b0", (-0.8, 9.6), (6.3, 9.6)); nl((1.0, 9.6), [0], "north")
  ...
  for (fx, sfx) in ((0, "a"), (5.5, "b")) {
    ...
    transformer("tx" + sfx, (fx, 8.87), (fx, 8.37), radius: 0.15, distance: 0.18)
  ...
  nl("b4.start", [4], "west"); bload("l4", (-1.6, 5.7))    // load at centre
  ...
  nl("b5.start", [5], "west"); load("l5", (-2.3, 4.8), size: 0.14, lead: 0.14, fill: black)
  ...
  nl("b11.end", [11], "east"); bload("l11", bus-frac("b11", 0.2)); bpv("pv11", bus-frac("b11", 0.8))
  ...
  nl("b10.end", [10], "east"); bload("l10", bus-frac("b10", 0.2))
  // Bus 9 — VERTICAL bus, midway between Bus 10 and Bus 7; firm black load.
  bus("b9", (0.1, 2.9), (0.1, 3.6))
  wire((-0.6, 4.1), (-0.6, 3.25)); wire((-0.6, 3.25), (0.3, 3.25))   // 0.8 km from Bus 10 → Bus 9 centre
  ticks((-0.6, 3.7), V); dl((-0.6, 4.1), (-0.6, 3.25), [0.8 km], "west")
  nl((0.3, 3.55), [9], "east")
  ...
  nl("b7.end", [7], "east"); bload("l7", bus-frac("b7", 0.5))   // load at centre
  // Bus 7 → Bus 9 tap (0.3 km): off Bus 7's left, down then west into Bus 9's centre.
  wire((0.8, 4.35), (0.8, 3.25)); wire((0.8, 3.25), (0.3, 3.25))
  ticks((0.8, 3.8), V); dl((0.8, 4.35), (0.8, 3.25), [0.3 km], "east")
  ...
  nl("b8.end", [8], "east"); bload("l8", bus-frac("b8", 0.15))
  ...
  wire((-2.0, 4.8), (-2.0, 1.2)); ticks((-2.0, 3.0), V)
  ...
  wire((5.5, 8.2), (5.5, 6.3)); ticks((5.5, 7.0), V)        // ticks lowered clear of the box top
  dl((5.5, 8.2), (5.5, 6.3), [4.9 km], "east")
  nl((6.05, 6.3), [13], "east"); bload("l13", bus-frac("b13", 0.25)); bpv("pv13", bus-frac("b13", 0.74))
  ...
  switch("s1", (3.6, 3.95), (4.1, 3.95)); nl((3.85, 4.1), [S1], "north")
  wire((4.1, 3.95), (5.5, 3.95)); ticks((4.8, 3.95), Hh)   // S1 → Bus 14; phase ticks right of S1
