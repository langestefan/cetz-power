...
#diagram(length: 1.2cm, {
  ...
  bus("hv", (0, 0), length: 1.2, angle: 90deg, stroke: 2.4pt + hv, label: (
    content: align(center)[HV \ 110 kV],
  ))
  bus("mv", (3, 0), length: 1.2, angle: 90deg, stroke: 1.8pt + mv, label: (
    content: align(center)[MV \ 11 kV],
  ))
  bus("lv", (6, 0), length: 1.2, angle: 90deg, stroke: 1.4pt + lv, label: (
    content: align(center)[LV \ 400 V],
  ))
