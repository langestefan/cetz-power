...
#diagram(length: 1cm, {
  ...
  cetz.draw.content(((on-x0 + on-x1) / 2, box-top - 0.25), text(size: 9pt)[Onderstation])
  cetz.draw.rect((sc-x0, box-top), (sc-x1, box-bot), stroke: dashed)
  cetz.draw.content(((sc-x0 + sc-x1) / 2, box-top - 0.25), text(size: 9pt)[Schakelstation])
  ...
  note((x-ts + 0.7, forky), [17.943 MW \ 8.903 Mvar],
    side: "south", text-align: center, size: 7pt)
  ...
  transformer("trafo", (tr-in, forky), (tr-out, forky),
    primary-stroke: feed + g, secondary-stroke: feed + black,
    radius: 0.26, distance: 0.28)
  ...
  note((x-osms - 0.7, forky), [-17.851 MW \ -6.848 Mvar], side: "south",
    text-align: center, size: 7pt)
  ...
  note((x-uit - 0.3, bus-top + 0.05), [RS-MS uitgaand \ 9.962 kV], side: "north",
    text-align: center)
  multi-wire("rsms", "uit", count: 1, from: (kf, kf), to: (kf, kf))
  note(((x-rsms + x-uit) / 2, koppy), [Koppelveld], side: "north")
  cetz.draw.content((x-rsms + 0.15, bus-bot + 0.35), anchor: "north-west",
    text(size: 7pt)[17.005 MW \ 6.991 Mvar])
  cetz.draw.content((x-uit - 0.15, bus-bot + 0.35), anchor: "north-east",
    text(size: 7pt)[-17.005 MW \ -6.991 Mvar])
